...
namespace NRL_Club_Management_WebSide
{
    ...
    {
        private Database_NRLClubEntities db = new Database_NRLClubEntities();
        ...
        public ActionResult Create([Bind(Include = "LadderID,ClubID,Position,Points,GamesWon,GamesLost")] Ladder ladder)
        {
            ...
            ViewBag.ClubID = new SelectList(db.Clubs, "ClubID", "ClubName", ladder.ClubID);
            return View(ladder);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "LadderID,ClubID,Position,Points,GamesWon,GamesLost")] Ladder ladder)
        {
            if (ModelState.IsValid)
            {
