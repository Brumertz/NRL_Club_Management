...
namespace NRL_WebSide
{
    public class LaddersController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "LadderID,ClubID,Position,Played,Points,Win,Draw,Lost,Byes,For,Against,Diff")] Ladder ladder)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "LadderID,ClubID,Position,Played,Points,Win,Draw,Lost,Byes,For,Against,Diff")] Ladder ladder)
        {
            if (ModelState.IsValid)
            {
